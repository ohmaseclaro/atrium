...
```bash
pnpm add express @atriumjs/atrium-server @atriumjs/atrium-react @atriumjs/atrium-worker react react-dom
pnpm exec playwright install chromium
```

`@atriumjs/atrium-protocol` is installed automatically by the public packages that need it. Install it directly only if you want to parse or validate wire messages yourself.
...
- React viewer props: [`@atriumjs/atrium-react`](../packages/react/README.md)
- Server API: [`@atriumjs/atrium-server`](../packages/server/README.md)
- Worker runtime: [`@atriumjs/atrium-worker`](../packages/worker/README.md)

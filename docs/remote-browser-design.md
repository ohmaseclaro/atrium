...
## 5. Wire protocol (`@atrium/protocol`)
...
## 6. Backend middleware: `@atrium/server`
...
## 7. Browser worker: `@atrium/worker`
...
## 8. React client: `@atrium/react`

### 8.1 Public API

```tsx
import { RemoteBrowser, useSession } from "@atrium/react";
